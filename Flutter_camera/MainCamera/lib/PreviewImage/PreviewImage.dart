                ...
                children: [ResponsiveGridCol(
                  ...
                  ResponsiveGridCol(
                    ...
                    child: new RaisedButton(
                      ...
                      child: Text("分享", style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500)),  // 5-2-1 分享圖片按鈕
                    ...
                    child: new RaisedButton(
                      ...
                      onPressed: () {
                        Navigator.push(context,new MaterialPageRoute(
                          builder: (context) => new ChooseLayoutScreen(imagePath: widget.imagePath)  // 5-2-2 進行版型挑選
                        ));
                      },
                    ),
                  ),
