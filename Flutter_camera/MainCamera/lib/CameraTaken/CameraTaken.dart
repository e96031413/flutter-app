  ...
  void _takePhoto() async {
    ImagePicker.pickImage(source: ImageSource.camera)  // 2-1-1從相機挑選照片(拍照)
      ...
      if (recordedImage != null && recordedImage.path != null) {
        ...
        GallerySaver.saveImage(recordedImage.path, albumName: albumName)    // 2-1-2保存照片至本地
            .then((bool success) {
          setState(() {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => PreviewImageScreen(imagePath: recordedImage.path),  // 2-1-3將照片傳送至預覽畫面
            ),
          );
        });
      }
